...
# ADDED: Import torch.multiprocessing for spawning multiple instances of main
...
# ADDED: Tensorboard libraries and variables - Not implemented but to be used
...
if __name__ == "__main__":
    #CHANGED: Use multiprocessing main function
    mp_main()
    #main()
